...
pub mod delay {
    ...
    impl_delay! {
        board: crate::sparkfun::pro_mini_5v
    }
}
...
pub mod port {
    ...
    /// ```
    #[macro_export]
    macro_rules! sparkfun_pro_mini_5v_pins {
        ($p:expr) => {
            $crate::sparkfun::pro_mini_5v::Pins::with_mcu_pins($crate::sparkfun::pro_mini_5v::hal::pins!($p))
        };
    }

    pub use sparkfun_pro_mini_5v_pins as pins;
}
...
pub mod usart {
    ...
    /// ```
    #[macro_export]
    macro_rules! sparkfun_pro_mini_5v_default_serial {
    ...
    pub use sparkfun_pro_mini_5v_default_serial as default_serial;
}
...
pub mod prelude {
    use crate::sparkfun::pro_mini_5v as board;
