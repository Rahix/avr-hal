...
macro_rules! impl_mod_simple_pwm {
    ($($mod:item)*) => {
        pub mod simple_pwm {
            ...
            use crate::r#impl::{impl_simple_pwm_peripheral_48p_168_328p_328pb, impl_simple_pwm_peripheral_1280_2560};
...
macro_rules! impl_simple_pwm_peripheral_48p_168_328p_328pb {
    () => {
...
pub(crate) use impl_simple_pwm_peripheral_48p_168_328p_328pb;

macro_rules! impl_simple_pwm_peripheral_1280_2560 {
    () => {
        avr_hal_generic::impl_simple_pwm! {
...
pub(crate) use impl_simple_pwm_peripheral_1280_2560;
